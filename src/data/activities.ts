...
export const allActivities: Activity[] = [
  ...
  // 2. Chez Ali Dinner Show
  {
    id: 2,
    slug: 'chez-ali',
    title: "Chez Ali - Magical Fantasia Dinner Show",
    description: "A unique evening in Marrakech that combines authentic Moroccan gastronomy and traditional shows. Under large caidal tents, you'll dive into the enchanting universe of One Thousand and One Nights, surrounded by horsemen, welcomed by Berber riders and traditional musicians, instantly transporting you into the magical atmosphere of ancestral Morocco. Make yourself comfortable under a caidal tent, decorated with carpets and lanterns, and let yourself be seduced by the authentic flavors of Moroccan cuisine. The magic doesn't stop there! After dinner, witness the legendary Fantasia show, a spectacular demonstration of Berber horsemen performing equestrian feats, galloping at full speed and firing rifles in an atmosphere full of emotions and pride.",
    options: {
      group: {
        price: 0,
        childPrice: 0,
    ...
    menuOptions: {
      tagineMenu: {
        price: 48,
        items: [
          "Moroccan Harira: Traditional soup with chickpeas, lentils, and mild spices",
          "Tagine (choice of chicken or meat) with Moroccan spices",
          "Couscous with seven vegetables and meat",
          "Seasonal fruits",
          "Mint tea",
          "Moroccan pastries (gazelle horns and briouates)"
        ]
      },
      mechouiMenu: {
        price: 60,
        ...
        items: [
          ...
          "1/2 Lamb Mechoui: Slow-roasted tender lamb",
          "Couscous with seven vegetables",
          "Seasonal fruits",
          "Mint tea",
          "Moroccan pastries (gazelle horns and almond cakes)"
        ]
      },
      specialEvents: {
        ramadan: {
        ...
        newYear: {
          price: 120,
          description: "Special festive menu and extended show"
        }
      }
    },
    image: uploadthingUrls.chezAliShow,
    duration: "4 Hours",
    category: "Soirées & Spectacles",
    subCategory: "Cultural Shows",
    location: "Marrakech",
    isPopular: true,
    isBestSeller: true,
    rating: 4.6,
    reviewCount: 312,
    video: "https://res.cloudinary.com/ddnyfqxze/video/upload/v1744396629/cheali_bwcu55.mp4",
    gallery: uploadthingUrls.chezAliShowGallery,
    highlights: [
      "Traditional welcome by Berber horsemen and musicians",
      "Authentic Moroccan dinner under caidal tents",
      "Spectacular Fantasia horse show with synchronized gunfire",
      "Folk music and traditional dance performances",
      "Oriental dance performances and Gnawa music",
      "Grand fireworks finale",
      "Round-trip hotel transfers included"
    ],
    included: [
      "Round-trip transportation from your hotel in Marrakech (departure at 19:00)",
      "Welcome by horsemen and traditional musicians",
      "Complete dinner according to chosen menu (Tagine Menu or Mechoui Menu)",
      "Fantasia Show"
    ],
    notIncluded: [
    ...
    recommendations: [
      "Regular departures: 19:00 from your hotel in Marrakech",
      "Special Ramadan hours: Departure at 20:45, after breaking the fast",
      "New Year's Eve celebrations: Special rate of €120 per person, including festive menu and extended show",
      "Mechoui Menu requires minimum 6 people"
    ],
    itinerary: [
      {
        activity: "Hotel Pickup",
        description: "Departure from your hotel in Marrakech at 19:00 (20:45 during Ramadan)",
        coordinates: [-7.9811, 31.6295]
      },
      {
        activity: "Traditional Welcome",
        description: "Upon arrival, welcome by Berber horsemen and musicians wearing traditional costumes. Guided to a luxurious caidal tent decorated with carpets and lanterns",
        coordinates: [-7.9559, 31.6636]
      },
      {
        activity: "Dinner Service",
        description: "Enjoy your chosen menu (Tagine or Mechoui) while being entertained by troops of dancers and traditional musicians performing oriental dance, Gnawa music, and other Moroccan folk styles",
        coordinates: [-7.9559, 31.6636]
      },
      {
        activity: "Fantasia Show",
        description: "Experience the evening's highlight - the Fantasia show featuring Berber horsemen performing acrobatics and frenzied gallops, synchronizing their black powder rifle shots in a spectacular celebration of Moroccan heritage",
        coordinates: [-7.9559, 31.6636]
      },
      {
        activity: "Grand Finale",
        description: "The evening concludes with a magnificent fireworks display, adding a final touch of enchantment to the magical atmosphere",
        coordinates: [-7.9559, 31.6636]
      },
      {
        activity: "Return Transfer",
        description: "Comfortable return transfer to your hotel in Marrakech",
        coordinates: [-7.9811, 31.6295]
      }
    ]
  },
